...
| Skill                    | Use for                                                     |
| ------------------------ | -------------------------------------------------------- |
| `security/security-review`     | Whole-surface review — deps, secrets leakage, races, authz, injection, SSRF |
| `security/audit-dependencies`  | Run the per-stack audit, triage by reachability, update packages safely |
