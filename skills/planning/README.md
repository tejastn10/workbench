...
Figure out *what* and *how* — and write it down — before building. Understanding,
alignment, breakdown, and the docs that capture decisions.

| Skill                    | Use for                                                     |
| ------------------------ | ------------------------------------------------------- |
| `planning/grill`               | Relentless interview to align on a plan before any code (adapted from Matt Pocock) |
...
| `planning/write-adr`           | Draft an ADR from the template (`../../docs/templates/ADR.md`) — numbered, immutable |

Order for a big piece of work: `planning/grill` → `planning/write-prd` → `planning/phased-delivery`.
